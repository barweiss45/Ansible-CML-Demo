...
RUN mkdir Ansible_CML_working_walkthrough
RUN git clone https://github.com/barweiss45/Ansible_CML_working_walkthrough.git Ansible_CML_working_walkthrough
